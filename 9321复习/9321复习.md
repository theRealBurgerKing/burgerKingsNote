...
Data Quality Problems Schema level data quality problems • prevented with better schema design, schema translation and integration. Instance level data quality problems • errors and inconsistencies of data that are not prevented at schema level
